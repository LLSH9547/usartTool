...
QT_MOC_LITERAL(1, 9, 17), // "sendComboBoxPress"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "myCombox\0sendComboBoxPress\0"
};
...
void myCombox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->sendComboBoxPress();
        ...
        {
            typedef int (myCombox::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myCombox::sendComboBoxPress)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
int myCombox::sendComboBoxPress()
{
    int _t0{};
